...
export const roles: Role[] = [
    ...
    { id: '6', name: 'Finance', description: 'Manages finances and approves requests', accessibleMenus: ['finance-dashboard', 'finance', 'payroll-history', 'koperasi-limit', 'warehouse'] },
